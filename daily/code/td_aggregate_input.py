...
____README____
Version 1.0
updated: 7/26/23 [copied from Tmax/Tmin workflow]
Description:
...
if __name__ == '__main__':
    ...
    date_code = pd.to_datetime(date_str).strftime('%Y_%m')
    filename = '_'.join((varname,input_source,date_code,'processed')) + '.csv'
