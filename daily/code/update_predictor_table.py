...
MASTER_DIR = r'/home/hawaii_climate_products_container/preliminary/relhum/'
#MASTER_DIR = r'/home/kodamak8/nrt_testing/relhum_test/relhum/'
DEP_MASTER_DIR = MASTER_DIR + r'daily/dependencies/'
PRED_DIR = DEP_MASTER_DIR + r'predictors/'
DEM_DIR = DEP_MASTER_DIR + r'geoTiffs_250m/dem/'
RUN_MASTER_DIR = MASTER_DIR + r'data_outputs/tables/station_data/daily/raw/statewide/'
...
if __name__=="__main__":
    ...
    old_pred = PRED_DIR + 'updated_TD_predictors.csv'
